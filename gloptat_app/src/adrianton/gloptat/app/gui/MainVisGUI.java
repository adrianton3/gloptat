...
public class MainVisGUI implements Runnable, MainGenericGUI {
	...
	private JComboBox<String> cmb_fun, cmb_oa;
	private JButton but_config, but_init, but_step, but_run, but_benchmark, but_plot;
	...
	void assembleGUI() {
		...
		// closing sequence //should close the display properly
